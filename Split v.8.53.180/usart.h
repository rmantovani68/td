...
#include "FWSelection.h"
	...
	//		SETTAGGI UART 1
	//------------------------------------------------------------------
	#define U1_Baud57600    57600		// Baudrate desiderato in bps LowSpeed
	...
	//		SETTAGGI UART 2
	//------------------------------------------------------------------
	#define U2_Baud9600		9600 		// Baudrate desiderato in bps
	#define U2_Baud19200	19200       // Baudrate desiderato in bps
	...
	#define U3_Baud19200	19200       // Baudrate desiderato in bps
	...
	//------------------------------------------------------------------
	#if U1_HighSpeed == 0
		#define U1_Divider57600 ((int)(FOSC/(16UL * U1_Baud57600) -1))    // LowSpeed
		#define U1_Divider115200 ((int)(FOSC/(16UL * U1_Baud115200) -1)   
		#define U1_Divider250000 ((int)(FOSC/(16UL * U1_Baud250000) -1)   
	#else
		#define U1_Divider57600 ((int)(FOSC/(4UL * U1_Baud57600) -1))     // LowSpeed
	...
	//------------------------------------------------------------------
	#if U2_HighSpeed == 0
		#define U2_Divider9600 ((int)(FOSC/(16UL * U2_Baud9600) -1))
		#define U2_Divider19200 ((int)(FOSC/(16UL * U2_Baud19200) -1))
	...
	#else
		#define U2_Divider9600 ((int)(FOSC/(4UL * U2_Baud9600) -1))
		#define U2_Divider19200 ((int)(FOSC/(4UL * U2_Baud19200) -1))
	...
	//------------------------------------------------------------------
		...
		#define U3_Divider19200 ((int)(FOSC/(16UL * U3_Baud19200) -1))
		#define U3_DividerLo38400 ((int)(FOSC/(16UL * U3_Baud38400) -1))
		...
		#define U3_Divider19200 ((int)(FOSC/(4UL * U3_Baud19200) -1))
		#define U3_DividerLo38400 ((int)(FOSC/(4UL * U3_Baud38400) -1))
    ...
    #define set_baudrateU2_9600()        \
		U2BRG = U2_Divider9600;		

	#define set_baudrateU2_19200()              \
		U2BRG = U2_Divider19200;					
	...
	#define set_baudrateU3_19200()              \
		U3BRG = U3_Divider19200;					
#endif
